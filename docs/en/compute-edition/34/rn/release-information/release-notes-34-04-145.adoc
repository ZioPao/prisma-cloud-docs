...
This bug affects all 34.04 Defenders. In the case the Defender is deployed on Tanzu Application Service (TAS), this may lead to severe connectivity issues.
