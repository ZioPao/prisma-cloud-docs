...
This bug affects all 34.04 Defenders. In the case of a Defender running on a machine that has an active policy such as Tanzu Application Service (TAS) or CNNS or DNS monitoring, this may lead to severe connectivity issues.
