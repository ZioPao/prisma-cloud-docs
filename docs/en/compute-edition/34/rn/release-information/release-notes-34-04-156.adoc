...
|Suppressed CVE-2026-33186 in the gRPC vendor dependency via database migration. The application does not use the `grpc/authz` package or implement custom path-based authorization interceptors on our gRPC servers, therefore the authorization bypass described in CVE-2026-33186 does not impact the application.
