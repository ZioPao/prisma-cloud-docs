...
|The following additional fixes are included in this release:

* CRI socket discovery race condition during boot, which could prevent the Defender from initializing properly.
* Added nftables support for Compliance checks.
* Resolved an issue where the Defender incorrectly reported an unhealthy state.
