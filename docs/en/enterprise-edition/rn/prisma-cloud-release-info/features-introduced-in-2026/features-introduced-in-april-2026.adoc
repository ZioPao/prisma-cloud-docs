...
|The retention period for audit events stored in the Prisma Cloud database changes from 120 days to 30 days. This update is part of our ongoing efforts to optimize performance and resource usage. The new retention period ensures a more responsive experience and efficient resource utilization across all environments. 
