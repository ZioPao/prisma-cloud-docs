...
|*Audit Log Retention Policy Updates*
//RLP=158209

|Prisma Cloud will update the retention policy for Cloud Service Provider (CSP) audit logs. The retention period for audit events stored in the Prisma Cloud database will change from 120 days to 30 days.

This change ensures a more responsive experience and efficient resource utilization across all environments. 
...
|Prisma Cloud has been updated to incorporate support for the CIS Amazon Web Services Foundations Benchmark v6.0.0 Level 1 and Level 2.
...
|Prisma Cloud has been updated to incorporate support for the CIS Microsoft Azure Foundations Benchmark v5.0.0 Level 1 and Level 2.
